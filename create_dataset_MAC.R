####################################################################################################
# Mass EduData Challenge, 2014 (MAC VERSION)
####################################################################################################
...
if (file.exists("MassDESEAPPerf0713")) {
  ...
  download.file(MassDESEAPPerf0713Url, destfile = "MassDESEAPPerf0713.csv", method = "curl")
}
...
if (file.exists("MassDESEMCASPerf2012")) {
  ...
  download.file(MassDESEMCASPerf2012Url, destfile = "MassDESEMCASPerf2012.csv", method = "curl")
}
